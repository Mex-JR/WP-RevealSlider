...
1. Admin dashboard showing all created sliders
2. Add/Edit slider interface with image upload
3. Slider customization options
4. Frontend slider in action (horizontal)
5. Frontend slider in action (vertical)
...
For support, bug reports, or feature requests, please visit our support forum or contact us through our website.

== Credits ==

This plugin was developed by Flowfunnel.
